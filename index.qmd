...
subtitle: "Choosing, running, interpreting, and communicating common applied analyses — responsibly"
toc: false
---

![](assets/hero.png){.course-hero-img fig-alt="Course identity hero for Applied Statistical Methods — a pink-and-green watermelon-tourmaline crystal cluster surrounded by applied-statistics graphics including a linear-model equation, group comparisons and one-way and two-way ANOVA, regression with residual diagnostics, a contingency table, and a logistic-regression curve, with the course title."}
...
is assumed; the work is scaffolded and the code is explained as it goes. On this draft course site, R is **shown as
static, syntax-highlighted teaching code** and is **not executed in place** (R is not installed in this build), so
...
This is a **draft course site**, not a finished release. Some pages are drafts, every numeric
value in the example datasets is **synthetic and provisional pending human review** (R is not executed in this
build, and the statistics/model-output gate is not yet cleared), and no accessibility-compliance claim is made.
Treat it as a work in progress rather than the final word.
:::
