# CLAUDE.md — applied-statistics (public Quarto site)

_Notes for Claude Code or any AI assistant working in this repo._

## What this repo is

The **public-facing Quarto course-materials site** for **Applied Statistical Methods**
...
`/applied-statistics/` under that domain, alongside the other course sites.
...
- `assets/icon.png` — square crystal mark with transparent background
  (a pink-and-green watermelon-tourmaline square mark); wired as the navbar `logo`.
